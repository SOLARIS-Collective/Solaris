...
/obj/machinery/barsign/update_icon_state()
	. = ..()
	// uses tg icon file
	if(!istype(chosen_sign, /datum/barsign/mankind) || icon_state == "empty")
		icon_state = initial(icon_state)
		return

	// uses modular icon file
	if(istype(chosen_sign, /datum/barsign/mankind/large))
		icon = 'modular_mankind/_storage_icons/icons/structures/barsigns/barsigns96x96.dmi'
	else
		icon = 'modular_mankind/_storage_icons/icons/structures/barsigns/barsigns.dmi'
...
/datum/barsign/mankind/large/cyberslyph
	name = "Cyberslyph"
