...
Этот мод добавляет новые ачивки в игру.
<!--
...
<!--
  ...
  Примеры: `code/__defines/~modular_mankind/achievements.dm`: `ACHIEVEMENTS_SPEED_MULTIPLIER`, `ACHIEVEMENTS_SPEED_BASE`
-->
