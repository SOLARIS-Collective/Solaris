/obj/item/bong
	...
	icon = 'modular_mankind/_storage_icons/icons/items/misc/bong.dmi'
	lefthand_file = 'modular_mankind/_storage_icons/icons/items/misc/in_hands/bong_lefthand.dmi'
	righthand_file = 'modular_mankind/_storage_icons/icons/items/misc/in_hands/bong_righthand.dmi'
	icon_state = "bongoff"
...
/obj/item/bong/attack(mob/hit_mob, mob/user, def_zone)
	...
	playsound(src, 'modular_mankind/_storage_sounds/sound/heatdam.ogg', 50, TRUE)
	if(!do_after(user, 40))
		return
	...
	if(moan_chance > 0)
		if(prob(moan_chance))
			playsound(hit_mob, pick('modular_mankind/_storage_sounds/sound/lungbust_moan1.ogg','modular_mankind/_storage_sounds/sound/lungbust_moan2.ogg', 'modular_mankind/_storage_sounds/sound/lungbust_moan3.ogg'), 50, TRUE)
			hit_mob.emote("moan")
		else
			playsound(hit_mob, pick('modular_mankind/_storage_sounds/sound/lungbust_cough1.ogg','modular_mankind/_storage_sounds/sound/lungbust_cough2.ogg'), 50, TRUE)
			hit_mob.emote("cough")
	if(bong_hits <= 0)
