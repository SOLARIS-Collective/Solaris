...
/datum/emote/living/carbon/mothchitter/get_sound(mob/living/user)
	return 'modular_mankind/_storage_sounds/sound/voice/moth/mothchitter.ogg'
...
/datum/emote/living/cough/get_sound(mob/living/user)
	...
	if(ishuman(user))
		if(user.gender == FEMALE)
			return pick(
				'modular_mankind/_storage_sounds/sound/voice/cough_female_1.ogg',
				'modular_mankind/_storage_sounds/sound/voice/cough_female_2.ogg')
		return pick(
			'modular_mankind/_storage_sounds/sound/voice/cough_male_1.ogg',
			'modular_mankind/_storage_sounds/sound/voice/cough_male_2.ogg',
			'modular_mankind/_storage_sounds/sound/voice/cough_male_3.ogg')
	return ..()
...
// 		if(user.gender == FEMALE)
// 			return pick(
// 				'modular_mankind/_storage_sounds/sound/voice/cry_female_1.ogg',
// 				'modular_mankind/_storage_sounds/sound/voice/cry_female_2.ogg',
// 				'modular_mankind/_storage_sounds/sound/voice/cry_female_3.ogg')
// 		return pick(
// 			'modular_mankind/_storage_sounds/sound/voice/cry_male_1.ogg',
// 			'modular_mankind/_storage_sounds/sound/voice/cry_male_1.ogg')
// 	return ..()
...
/datum/emote/living/gag/get_sound(mob/living/user)
	...
	if(!H.mind || !H.mind.miming)
		if(user.gender == FEMALE)
			return pick(
				'modular_mankind/_storage_sounds/sound/voice/human/gasp_female1.ogg',
				'modular_mankind/_storage_sounds/sound/voice/human/gasp_female2.ogg',
				'modular_mankind/_storage_sounds/sound/voice/human/gasp_female3.ogg',
				'modular_mankind/_storage_sounds/sound/voice/human/gasp_female4.ogg',
				'modular_mankind/_storage_sounds/sound/voice/human/gasp_female5.ogg',
				'modular_mankind/_storage_sounds/sound/voice/human/gasp_female6.ogg',
				'modular_mankind/_storage_sounds/sound/voice/human/gasp_female7.ogg')
		else
			return pick(
				'modular_mankind/_storage_sounds/sound/voice/human/gasp_male1.ogg',
				'modular_mankind/_storage_sounds/sound/voice/human/gasp_male2.ogg',
				'modular_mankind/_storage_sounds/sound/voice/human/gasp_male3.ogg',
				'modular_mankind/_storage_sounds/sound/voice/human/gasp_male4.ogg',
				'modular_mankind/_storage_sounds/sound/voice/human/gasp_male5.ogg',
				'modular_mankind/_storage_sounds/sound/voice/human/gasp_male6.ogg',
				'modular_mankind/_storage_sounds/sound/voice/human/gasp_male7.ogg')
	if(ismoth(H))
		return 'modular_mankind/_storage_sounds/sound/voice/human/gasp_female3.ogg'
...
/datum/emote/living/giggle/get_sound(mob/living/user)
	...
	if(ishuman(user))
		if(user.gender == FEMALE)
			return pick(
				'modular_mankind/_storage_sounds/sound/voice/giggle_female_1.ogg',
				'modular_mankind/_storage_sounds/sound/voice/giggle_female_2.ogg',
				'modular_mankind/_storage_sounds/sound/voice/giggle_female_3.ogg')
		return pick(
			'modular_mankind/_storage_sounds/sound/voice/giggle_male_1.ogg',
			'modular_mankind/_storage_sounds/sound/voice/giggle_male_2.ogg')
	return ..()
...
/datum/emote/living/groan/get_sound(mob/living/user)
	...
	if(ishuman(user))
		if(user.gender == FEMALE)
			return pick(
				'modular_mankind/_storage_sounds/sound/voice/moan_female_1.ogg',
				'modular_mankind/_storage_sounds/sound/voice/moan_female_2.ogg',
				'modular_mankind/_storage_sounds/sound/voice/moan_female_3.ogg')
		return pick(
			'modular_mankind/_storage_sounds/sound/voice/moan_male_1.ogg',
			'modular_mankind/_storage_sounds/sound/voice/moan_male_2.ogg',
			'modular_mankind/_storage_sounds/sound/voice/moan_male_3.ogg')
	return ..()
...
/datum/emote/living/laugh/get_sound(mob/living/user)
	...
	if(!H.mind || !H.mind.miming)
		if(user.gender == FEMALE)
			return 'modular_mankind/_storage_sounds/sound/voice/human/womanlaugh.ogg'
		else
			return pick(
				'modular_mankind/_storage_sounds/sound/voice/human/manlaugh1.ogg',
				'modular_mankind/_storage_sounds/sound/voice/human/manlaugh2.ogg')
	if(ismoth(H))
		return 'modular_mankind/_storage_sounds/sound/voice/moth/mothlaugh.ogg'
...
/datum/emote/living/laugh_evil/get_sound(mob/living/user)
	...
	if(!H.mind || !H.mind.miming)
		if(user.gender == FEMALE)
			return pick(
				'modular_mankind/_storage_sounds/sound/emotes/female/laugh_f1.ogg',
				'modular_mankind/_storage_sounds/sound/emotes/female/laugh_f2.ogg')
		else
			return pick(
				'modular_mankind/_storage_sounds/sound/emotes/male/laugh_m1.ogg',
				'modular_mankind/_storage_sounds/sound/emotes/male/laugh_m2.ogg')
...
/datum/emote/living/carbon/mothsqueak/get_sound(mob/living/user)
	return 'modular_mankind/_storage_sounds/sound/voice/moth/mothsqueak.ogg'
...
/datum/emote/living/sigh/run_emote(mob/living/user, params, type_override, intentional)
	...
	if(!ishuman(user))
		return
	var/image/emote_animation = image('modular_mankind/_storage_icons/icons/assets/qol/emote_visuals.dmi', user, "sigh")
...
/datum/emote/living/sigh/get_sound(mob/living/user)
	...
	if(ishuman(user))
		if(user.gender == FEMALE)
			return pick('modular_mankind/_storage_sounds/sound/voice/sigh_female.ogg')
		return pick('modular_mankind/_storage_sounds/sound/voice/sigh_male.ogg', 'modular_mankind/_storage_sounds/sound/voice/sigh_male.ogg')
	return ..()
...
/datum/emote/living/sneeze/get_sound(mob/living/user)
	...
	if(ishuman(user))
		if(user.gender == FEMALE)
			return pick('modular_mankind/_storage_sounds/sound/voice/sneeze_female.ogg')
		return pick('modular_mankind/_storage_sounds/sound/voice/sneeze.ogg')
	return ..()
...
/datum/emote/living/sniff/get_sound(mob/living/user)
	...
	if(ishuman(user))
		if(user.gender == FEMALE)
			return pick('modular_mankind/_storage_sounds/sound/emotes/female/sniff_female.ogg')
		else
			return pick('modular_mankind/_storage_sounds/sound/emotes/male/male_sniff.ogg')

	// if(ishuman(user))
	// 	if(user.gender == FEMALE)
	// 		return pick('modular_mankind/_storage_sounds/sound/voice/sniff_female.ogg')
	// 	return pick('modular_mankind/_storage_sounds/sound/voice/sniff_male.ogg')
	return ..()
...
/datum/emote/living/snore/get_sound(mob/living/user)
	...
	if(ishuman(user))
		return pick(
			'modular_mankind/_storage_sounds/sound/voice/snore_1.ogg',
			'modular_mankind/_storage_sounds/sound/voice/snore_2.ogg',
			'modular_mankind/_storage_sounds/sound/voice/snore_3.ogg',
			'modular_mankind/_storage_sounds/sound/voice/snore_4.ogg',
			'modular_mankind/_storage_sounds/sound/voice/snore_5.ogg',
			'modular_mankind/_storage_sounds/sound/voice/snore_6.ogg',
			'modular_mankind/_storage_sounds/sound/voice/snore_7.ogg')
	return ..()
...
/datum/emote/living/yawn/get_sound(mob/living/user)
	...
	if(ishuman(user))
		if(user.gender == FEMALE)
			return pick(
				'modular_mankind/_storage_sounds/sound/voice/yawn_female_1.ogg',
				'modular_mankind/_storage_sounds/sound/voice/yawn_female_2.ogg',
				'modular_mankind/_storage_sounds/sound/voice/yawn_female_3.ogg')
		return pick(
			'modular_mankind/_storage_sounds/sound/voice/yawn_male_1.ogg',
			'modular_mankind/_storage_sounds/sound/voice/yawn_male_2.ogg')
	return ..()
...
/datum/emote/living/gurgle/get_sound(mob/living/user)
	return 'modular_mankind/_storage_sounds/sound/emotes/jelly/gurgle.ogg'
...
// 	if(!ishuman(user))
// 		return pick('modular_mankind/_storage_sounds/sound/emotes/whistle.ogg')
// 	// if(ishuman(user))
// 	return pick('modular_mankind/_storage_sounds/sound/voice/whistle.ogg')
// 	// return ..()
...
/datum/emote/living/warcray/get_sound(mob/living/user)
	...
	if(!H.mind || !H.mind.miming)
		if(user.gender == FEMALE)
			return pick(
			'modular_mankind/_storage_sounds/sound/voice/human_female_warcry_1.ogg',
			'modular_mankind/_storage_sounds/sound/voice/human_female_warcry_2.ogg',
			'modular_mankind/_storage_sounds/sound/voice/human_female_warcry_3.ogg',
			'modular_mankind/_storage_sounds/sound/voice/human_female_warcry_4.ogg',
			'modular_mankind/_storage_sounds/sound/voice/human_female_warcry_5.ogg')
		else
			return pick(
			'modular_mankind/_storage_sounds/sound/voice/human_male_warcry_1.ogg',
			'modular_mankind/_storage_sounds/sound/voice/human_male_warcry_2.ogg',
			'modular_mankind/_storage_sounds/sound/voice/human_male_warcry_3.ogg',
			'modular_mankind/_storage_sounds/sound/voice/human_male_warcry_4.ogg',
			'modular_mankind/_storage_sounds/sound/voice/human_male_warcry_5.ogg',
			'modular_mankind/_storage_sounds/sound/voice/human_male_warcry_6.ogg',
			'modular_mankind/_storage_sounds/sound/voice/human_male_warcry_7.ogg',
			'modular_mankind/_storage_sounds/sound/voice/human_male_warcry_8.ogg',
			'modular_mankind/_storage_sounds/sound/voice/human_male_warcry_9.ogg')
	if(ismoth(H))
		if(prob(3))
			message = "издаёт вдохновляющий крик!"
			return 'modular_mankind/_storage_sounds/sound/voice/alastor_attack1-attackvoice.ogg'
		else
			message = "издаёт вдохновляющий крик!"
			return pick(
			'modular_mankind/_storage_sounds/sound/voice/alastor_wing1.ogg',
			'modular_mankind/_storage_sounds/sound/voice/alastor_wing1_2.ogg',
			'modular_mankind/_storage_sounds/sound/voice/alastor_wing2.ogg',
			'modular_mankind/_storage_sounds/sound/voice/alastor_wing2_2.ogg')
...
/datum/emote/living/choke/get_sound(mob/living/user)
	...
	if(user.gender == FEMALE)
		return pick(
			'modular_mankind/_storage_sounds/sound/emotes/female/choke_female_1.ogg',
			'modular_mankind/_storage_sounds/sound/emotes/female/choke_female_2.ogg',
			'modular_mankind/_storage_sounds/sound/emotes/female/choke_female_3.ogg')
	else
		return pick(
			'modular_mankind/_storage_sounds/sound/emotes/male/choke_male_1.ogg',
			'modular_mankind/_storage_sounds/sound/emotes/male/choke_male_2.ogg',
			'modular_mankind/_storage_sounds/sound/emotes/male/choke_male_3.ogg')
...
/datum/emote/living/sniff/get_sound(mob/living/user)
	...
	// . = ..()
	if(user.gender == FEMALE)
		return 'modular_mankind/_storage_sounds/sound/emotes/female/sniff_female.ogg'
	else
		return 'modular_mankind/_storage_sounds/sound/emotes/male/sniff_male.ogg'

// /datum/emote/living/snore/get_sound(mob/living/user)
// 	. = ..()
// 	if(iscarbon(user))
// 		return pick(
// 			'modular_mankind/_storage_sounds/sound/emotes/snore_1.ogg',
// 			'modular_mankind/_storage_sounds/sound/emotes/snore_2.ogg',
// 			'modular_mankind/_storage_sounds/sound/emotes/snore_3.ogg',
// 			'modular_mankind/_storage_sounds/sound/emotes/snore_4.ogg',
// 			'modular_mankind/_storage_sounds/sound/emotes/snore_5.ogg',
// 			'modular_mankind/_storage_sounds/sound/emotes/snore_6.ogg',
// 			'modular_mankind/_storage_sounds/sound/emotes/snore_7.ogg')
...
/datum/emote/living/carbon/yawn/get_sound(mob/living/user)
	...
	if(user.gender == FEMALE)
		return pick(
			'modular_mankind/_storage_sounds/sound/emotes/female/yawn_female_1.ogg',
			'modular_mankind/_storage_sounds/sound/emotes/female/yawn_female_2.ogg',
			'modular_mankind/_storage_sounds/sound/emotes/female/yawn_female_3.ogg')
	else
		return pick(
			'modular_mankind/_storage_sounds/sound/emotes/male/yawn_male_1.ogg',
			'modular_mankind/_storage_sounds/sound/emotes/male/yawn_male_2.ogg')
...
/datum/emote/living/carbon/human/salute/get_sound(mob/living/user)
	...
	if(!is_type_in_list(H.shoes, funny_shoes))
		return 'modular_mankind/_storage_sounds/sound/emotes/salute.ogg'
	if(is_type_in_list(H.shoes, funny_shoes))
		return 'modular_mankind/_storage_sounds/sound/emotes/toysqueak1.ogg'
...
/datum/emote/living/carbon/human/fart
	...
	sound = 'modular_mankind/_storage_sounds/sound/emotes/fart.ogg'
...
/datum/emote/living/carbon/human/whistle/get_sound(mob/living/user)
	...
	return 'modular_mankind/_storage_sounds/sound/emotes/whistle.ogg'
...
/datum/emote/living/carbon/human/snuffle/get_sound(mob/living/user)
	...
	if(ishuman(user))
		if(user.gender == FEMALE)
			return pick('modular_mankind/_storage_sounds/sound/emotes/female/female_sniff.ogg')
		else
			return pick('modular_mankind/_storage_sounds/sound/emotes/male/male_sniff.ogg')
...
/datum/emote/living/carbon/human/roar/get_sound(mob/living/user)
	return pick(
		'modular_mankind/_storage_sounds/sound/emotes/unathi/roar_unathi_1.ogg',
		'modular_mankind/_storage_sounds/sound/emotes/unathi/roar_unathi_2.ogg',
		'modular_mankind/_storage_sounds/sound/emotes/unathi/roar_unathi_3.ogg')
...
/datum/emote/living/carbon/human/rumble/get_sound(mob/living/user)
	return pick(
		'modular_mankind/_storage_sounds/sound/emotes/unathi/rumble_unathi_1.ogg',
		'modular_mankind/_storage_sounds/sound/emotes/unathi/rumble_unathi_2.ogg')
...
/datum/emote/living/carbon/human/threat/get_sound(mob/living/user)
	return pick(
		'modular_mankind/_storage_sounds/sound/emotes/unathi/threat_unathi_1.ogg',
		'modular_mankind/_storage_sounds/sound/emotes/unathi/threat_unathi_2.ogg')
...
/datum/emote/living/carbon/human/purr
	...
	age_based = TRUE
	vary = TRUE
	sound = 'modular_mankind/_storage_sounds/sound/emotes/tajaran/purr_tajaran.ogg'
	volume = 80
...
/datum/emote/living/carbon/human/purrl
	...
	age_based = TRUE
	vary = TRUE
	sound = 'modular_mankind/_storage_sounds/sound/emotes/tajaran/purr_tajaran_long.ogg'
	volume = 80
	muzzled_noises = list("слабый мурчащий")
...
/datum/emote/living/carbon/human/mrowss
	...
	sound = 'modular_mankind/_storage_sounds/sound/emotes/tajaran/mrowss.ogg'
	// species_type_whitelist_typecache = list(/datum/species/tajaran)
	emote_type = EMOTE_VISIBLE | EMOTE_AUDIBLE
	vary = TRUE
	cooldown = 5 SECONDS
...
/datum/emote/living/carbon/human/hiss/tajara
	...
	// species_type_whitelist_typecache = list(/datum/species/tajaran)
	sound = 'modular_mankind/_storage_sounds/sound/emotes/tajaran/hiss_tajaran.ogg'
	volume = 80
...
/datum/emote/living/carbon/human/hiss/get_sound(mob/living/user)
	if(!ishuman(user))
		return
	if(istajara(user))
		return 'modular_mankind/_storage_sounds/sound/emotes/tajaran/hiss_tajaran.ogg'
	if(islizard(user))
...
/datum/emote/living/carbon/human/whip
	...
	volume = 75
	// audio_cooldown = 3 SECONDS
	sound = 'modular_mankind/_storage_sounds/sound/emotes/unathi/whip_short_unathi.ogg'
...
/datum/emote/living/carbon/human/whip/whip_l
	...
	sound = 'modular_mankind/_storage_sounds/sound/emotes/unathi/whip_unathi.ogg'
...
// 	sound = 'modular_mankind/_storage_sounds/sound/emotes/bark.ogg'
...
// 	sound = 'modular_mankind/_storage_sounds/sound/emotes/wbark.ogg'
// 	// species_type_whitelist_typecache = list(/datum/species/vulpkanin)
// 	emote_type = EMOTE_AUDIBLE
// 	age_based = TRUE
// 	vary = TRUE
...
/datum/emote/living/carbon/human/ururu
	...
	message = "урчит."
	message_param = "урчит на %t."
	sound = 'modular_mankind/_storage_sounds/sound/emotes/vulpkanin/purr.ogg'
	// species_type_whitelist_typecache = list(/datum/species/vulpkanin)
	emote_type = EMOTE_VISIBLE | EMOTE_MOUTH | EMOTE_AUDIBLE
	vary = TRUE
	cooldown = 10 SECONDS
...
/datum/emote/living/carbon/human/meow
	...
	sound = 'modular_mankind/_storage_sounds/sound/emotes/tajaran/meow_tajaran.ogg'
	// species_type_whitelist_typecache = list(/datum/species/tajaran)
	emote_type = EMOTE_VISIBLE | EMOTE_MOUTH | EMOTE_AUDIBLE
	vary = TRUE
	cooldown = 10 SECONDS
...
/datum/emote/living/carbon/human/tajara/mrow
	...
	sound = 'modular_mankind/_storage_sounds/sound/emotes/tajaran/annoyed_meow_tajaran.ogg'
	// species_type_whitelist_typecache = list(/datum/species/tajaran)
	emote_type = EMOTE_VISIBLE | EMOTE_MOUTH | EMOTE_AUDIBLE
	vary = TRUE
	cooldown = 10 SECONDS
...
/datum/emote/living/carbon/human/snap
	...
	sound = 'modular_mankind/_storage_sounds/sound/emotes/fingersnap.ogg'
...
// 	return 'modular_mankind/_storage_sounds/sound/purr.ogg'
...
// 	return 'modular_mankind/_storage_sounds/sound/purr_long.ogg'
...
/datum/emote/living/carbon/human/glasses/run_emote(mob/user, params, type_override, intentional)
	if(!..())
		return FALSE
	var/image/emote_animation = image('modular_mankind/_storage_icons/icons/assets/qol/emote_visuals.dmi', user, "glasses")
...
/datum/emote/living/flutter/get_sound(mob/living/user)
	if(!ishuman(user))
		return
	return 'modular_mankind/_storage_sounds/sound/voice/moth/moth_flutter.ogg'
...
/datum/emote/living/carbon/human/jelly/squish/get_sound(mob/living/user)
	return 'modular_mankind/_storage_sounds/sound/plushes/voice/slime_squish.ogg'
...
/datum/emote/living/carbon/human/jelly/bubble/get_sound(mob/living/user)
	return 'modular_mankind/_storage_sounds/sound/emotes/mob_effects/slime_bubble.ogg'
...
/datum/emote/living/carbon/human/jelly/pop/get_sound(mob/living/user)
	return 'modular_mankind/_storage_sounds/sound/emotes/mob_effects/slime_pop.ogg'
...
/datum/emote/living/carbon/human/quill/get_sound(mob/living/user)
	return pick(
		'modular_mankind/_storage_sounds/sound/emotes/kepori/quill_1.ogg',
		'modular_mankind/_storage_sounds/sound/emotes/kepori/quill_2.ogg')
