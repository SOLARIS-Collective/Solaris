...
<!--
  ...
  Примеры: `code/__defines/~mod_mankind/mankind_modsuits.dm`: `MANKIND_MODSUITS_SPEED_MULTIPLIER`, `MANKIND_MODSUITS_SPEED_BASE`
-->

### Используемые файлы, не содержащиеся в модпаке

- `mod_mankind\_storage_icons\icons\items\clothing\mod_suit\overlay\mod_clothing.dmi`
- `mod_mankind\_storage_icons\icons\items\clothing\mod_suit\overlay\mod_modules.dmi`

- `mod_mankind\_storage_icons\icons\items\clothing\mod_suit\mod_clothing.dmi`
- `mod_mankind\_storage_icons\icons\items\clothing\mod_suit\mod_modules.dmi`
- `mod_mankind\_storage_icons\icons\items\clothing\mod_suit\mod_construction.dmi`
- `mod_mankind\_storage_icons\icons\assets\effects.dmi`
- `mod_mankind\_storage_icons\icons\items\weapons\grenade.dmi`
<!--
