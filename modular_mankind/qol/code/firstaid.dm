/obj/item/storage/firstaid/synthflesh
	...
	icon = 'modular_mankind/_storage_icons/icons/items/misc/storage.dmi'
	icon_state = "synthflesh"
	lefthand_file = 'modular_mankind/_storage_icons/icons/items/misc/in_hands/storage_hands_left.dmi'
	righthand_file = 'modular_mankind/_storage_icons/icons/items/misc/in_hands/storage_hands_right.dmi'
