/obj/structure/curtain/cloth/purpl
	icon = 'modular_mankind/_storage_icons/icons/structures/fancy.dmi'
...
/turf/open/floor/plasteel/strongdark
	icon = 'modular_mankind/_storage_icons/icons/structures/floors/dark.dmi'
	icon_state = "dark"
...
/turf/open/floor/plasteel/heavymetal
	icon = 'modular_mankind/_storage_icons/icons/structures/floors/metal_2.dmi'
	icon_state = "metal_1"
