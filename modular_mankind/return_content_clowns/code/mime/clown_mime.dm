...
/obj/item/clothing/under/rank/civilian/mime
	...
	icon = 'modular_mankind/_storage_icons/icons/other/clown_mime/service.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/other/clown_mime/service_on_mob.dmi'
	icon_state = "mime"
	item_state = "mime"
