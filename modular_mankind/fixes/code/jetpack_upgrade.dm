/obj/item/tank/jetpack/suit
	...
	icon = 'modular_mankind/_storage_icons/icons/items/misc/jetpackitems.dmi' //Changed item icon
...
/obj/item/tank/jetpack/suit/turn_on(mob/user)
	...
	icon = 'modular_mankind/_storage_icons/icons/items/misc/jetpacktank.dmi'
