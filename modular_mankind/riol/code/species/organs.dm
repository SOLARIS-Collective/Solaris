...
/obj/item/organ/ears/riol
	name = "riol ears"
	icon = 'modular_mankind/_storage_icons/icons/species/riol/riol_organs.dmi'	//пока такая хурма, но нужно будет сделать уши отдельно от головы и втыкнуть в какой-либо файл
	icon_state = "ears"					//когда будут уши в каком-то файле, тогда и поменяешь
	damage_multiplier = 2
	bang_protect = -0.2	// MANKIND_BALANCE_SPECIES - Снижаем устойчивость к громким звукам на 20%
...
/obj/item/organ/eyes/riol
	name = "Riol eyes"
	icon = 'modular_mankind/_storage_icons/icons/species/riol/riol_organs.dmi'
	icon_state = "eyes"
	desc = "Some eyes"
...
/obj/item/organ/tail/riol
	...
	icon = 'modular_mankind/_storage_icons/icons/species/riol/riol_lang.dmi'
	icon_state = "vulptail"
	color = "#661111"
	tail_type = "Long"
