...
<!--
  ...
  Примеры: `code/__defines/~modular_mankind/vending_cash.dm`: `VENDING_CASH_SPEED_MULTIPLIER`, `VENDING_CASH_SPEED_BASE`
-->

### Используемые файлы, не содержащиеся в модпаке

- `tgui\packages\tgui\interfaces\VendingMankind\`:
	`..\VendingMankind\VendingSections.js`
	`..\VendingMankind\types.ts`
	`..\VendingMankind\index.tsx`
<!--
