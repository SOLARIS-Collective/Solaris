/obj/item/clothing/under/el_cloth_1
	...
	icon = 'modular_mankind/_storage_icons/icons/items/clothing/under/el_cloth.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/clothing/under/overlay/el_cloth.dmi'
