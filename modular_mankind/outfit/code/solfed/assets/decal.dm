/obj/effect/turf_decal/solgov
	icon = 'modular_mankind/_storage_icons/icons/structures/logo/sol_fed_logo.dmi'
	icon_state = "11"
...
/obj/effect/turf_decal/tssc_small
	...
	icon = 'modular_mankind/_storage_icons/icons/structures/manufacturer_decals.dmi'
