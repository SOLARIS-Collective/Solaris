...
/obj/item/clothing/suit/armor/vest/gamma
	...
	desc = "No data."
	icon = 'modular_mankind/_storage_icons/icons/items/clothing/under/gammauniform.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/clothing/under/overlay/gammauniform.dmi'
...
/obj/item/clothing/gloves/combat/gamma
	...
	desc = "No data."
	icon = 'modular_mankind/_storage_icons/icons/items/clothing/hands/gammagloves.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/clothing/hands/overlay/gammagloves.dmi'
...
/obj/item/clothing/shoes/gamma
	name = "Gamma boots"
	desc = "no data."
	icon = 'modular_mankind/_storage_icons/icons/items/clothing/feet/gammashoes.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/clothing/feet/overlay/gammashoes.dmi'
...
/obj/item/melee/gamma_tomahawk
	name = "gamma tomahawk"
	desc = "no data"
	icon = 'modular_mankind/_storage_icons/icons/items/weapons/axeweapons.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/weapons/overlay/axeweapons.dmi'
	lefthand_file = 'modular_mankind/_storage_icons/icons/items/weapons/in_hands/weapons_hands_left.dmi'
	righthand_file = 'modular_mankind/_storage_icons/icons/items/weapons/in_hands/weapons_hands_right.dmi'
