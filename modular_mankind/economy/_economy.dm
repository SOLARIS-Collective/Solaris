...
/datum/modpack/economy
	name = "Экономика"
	desc = "Этот модпак затрагивает любые цены в игре на покупку и продажу."
	author = "MrCat15352, Minibebuska"
...
// Инициализация ДО
/datum/modpack/economy/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/economy/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/economy/post_initialize()
	. = ..()
