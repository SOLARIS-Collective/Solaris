/obj/machinery/rnd/production/techfab/department
	icon = 'modular_mankind/_storage_icons/icons/machinery/research.dmi'
	icon_state = "techfab"
...
/obj/machinery/rnd/production/proc/add_department_stripe(obj/machinery/rnd/production/M, list/overlays)
	if(M.department_tag)
		...
		var/mutable_appearance/stripe_overlay = mutable_appearance('modular_mankind/_storage_icons/icons/machinery/research.dmi', stripe_icon)
...
/obj/machinery/rnd/AfterMaterialInsert(obj/item/item_inserted, id_inserted, amount_inserted)
	...
	if(istype(src, /obj/machinery/rnd/production/protolathe/department))
		flick_overlay_view(mutable_appearance('modular_mankind/_storage_icons/icons/machinery/research.dmi', "protolathe_[stack_name]"), 1 SECONDS)
		...
		flick_overlay_view(mutable_appearance('modular_mankind/_storage_icons/icons/machinery/research.dmi', "techfab_[stack_name]"), 1 SECONDS)
...
/obj/machinery/rnd/production/proc/OnMatInsertAnimationHook(datum/source, obj/item/I, mob/living/user)
	...
	if(!MC.has_space(to_insert))
		if(istype(src, /obj/machinery/rnd/production/protolathe/department))
			flick_overlay_view(mutable_appearance('modular_mankind/_storage_icons/icons/machinery/research.dmi', "protolathe_deny"), 1 SECONDS)
		else if(istype(src, /obj/machinery/rnd/production/techfab/department))
			flick_overlay_view(mutable_appearance('modular_mankind/_storage_icons/icons/machinery/research.dmi', "techfab_deny"), 1 SECONDS)
		return
