...
Мод добавляет поддержку кириллицы в hand_labeler, использует regex для проверки паттернов текста, использует hex коды
<!--
...
- `code\modules\paperwork\handlabeler.dm` : `proc/attack_self`, `proc/afterattack`
<!--
