...
<!--
  ...
  Примеры: `code/__defines/~modular_mankind/modsuits.dm`: `MANKIND_MODSUITS_SPEED_MULTIPLIER`, `MANKIND_MODSUITS_SPEED_BASE`
-->

### Используемые файлы, не содержащиеся в модпаке

- `modular_mankind\_storage_icons\icons\items\clothing\mod_suit\overlay\mod_clothing.dmi`
- `modular_mankind\_storage_icons\icons\items\clothing\mod_suit\overlay\mod_modules.dmi`

- `modular_mankind\_storage_icons\icons\items\clothing\mod_suit\mod_clothing.dmi`
- `modular_mankind\_storage_icons\icons\items\clothing\mod_suit\mod_modules.dmi`
- `modular_mankind\_storage_icons\icons\items\clothing\mod_suit\mod_construction.dmi`
- `modular_mankind\_storage_icons\icons\assets\effects.dmi`
- `modular_mankind\_storage_icons\icons\items\weapons\grenade.dmi`
<!--
