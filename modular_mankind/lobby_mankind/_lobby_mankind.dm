...
// Инициализация ДО
//datum/modpack/music_mankind/pre_initialize()
//	. = ..()

// Инициализация ВОВРЕМЯ
//datum/modpack/music_mankind/initialize()
//	. = ..()

// Инициализация ПОСЛЕ
//datum/modpack/music_mankind/post_initialize()
//	. = ..()
