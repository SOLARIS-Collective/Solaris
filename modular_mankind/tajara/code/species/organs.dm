...
/obj/item/organ/eyes/tajara
	name = "Tajara eyes"
	icon = 'modular_mankind/_storage_icons/icons/species/tajara/tajara_organs.dmi'
	icon_state = "night_eyes_off"
	desc = "Some eyes"
	actions_types = list(/datum/action/item_action/organ_action/toggle)
	var/active = FALSE
	var/current_lighting_alpha = null
	flash_protect = FLASH_PROTECTION_SENSITIVE	// MANKIND_BALANCE_SPECIES - Для баланса, глаза стали чувствительными
