/mob/living/simple_animal/pet/dog/corgi/pig
	...
	real_name = "Pig"
	desc = "Grunts."
	icon = 'modular_mankind/_storage_icons/icons/mobs/pet_content/pets.dmi'
	icon_state = "pigs"
	icon_living = "pigs"
	icon_dead = "pigs_dead"
	...
	maxHealth = 50
	health = 50
	attacked_sound = 'modular_mankind/_storage_sounds/sound/mobs/pig/oink.ogg'
	deathsound = 'modular_mankind/_storage_sounds/sound/mobs/pig/death.ogg'
...
/mob/living/simple_animal/pet/dog/corgi/pig/Life()
	...
	if(stat)
		return
	if(prob(10))
		var/chosen_sound = pick('modular_mankind/_storage_sounds/sound/mobs/pig/hru.ogg', 'modular_mankind/_storage_sounds/sound/mobs/pig/oink.ogg', 'modular_mankind/_storage_sounds/sound/mobs/pig/squeak.ogg')
...
/obj/item/food/meat/slab/pig
	name = "salo"
	icon_state = "salo"
	icon = 'modular_mankind/_storage_icons/icons/items/misc/salo.dmi'
	foodtypes = MEAT
