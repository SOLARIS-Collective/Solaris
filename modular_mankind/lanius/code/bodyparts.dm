...
/obj/item/organ/tongue/lanius
	...
	icon = 'modular_mankind/_storage_icons/icons/species/lanius/lanius_organs.dmi'
	icon_state = "tongue"
	say_mod = "clicks"
	decay_factor = 5
	useable = FALSE
...
/obj/item/bodypart/head/lanius
	icon = 'modular_mankind/_storage_icons/icons/species/lanius/lanius_bodyparts.dmi'
