...
/obj/item/stack/sheet/metal/attack(mob/living/M, mob/living/user, def_zone)
	...
	if(islanius(M))
		if(M.nutrition > (600))	// The more you eat - the more you can eat
			...
			return FALSE
		playsound(M.loc,pick('modular_mankind/_storage_sounds/sound/lanius/bp_sfx_RockMan_Thud1_01.ogg',
		'modular_mankind/_storage_sounds/sound/lanius/bp_sfx_RockMan_Thud2_01.ogg',
		'modular_mankind/_storage_sounds/sound/lanius/bp_sfx_RockMan_Thud3_01.ogg'), rand(10,50), TRUE)
...
/atom/movable/screen/alert/hungry/lanius
	icon = 'modular_mankind/_storage_icons/icons/species/lanius/screen_alert.dmi'
	name = "Hungry"
