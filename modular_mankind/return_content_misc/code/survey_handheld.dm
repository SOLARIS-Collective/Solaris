...
/obj/item/survey_handheld_rnd/advanced
...
/obj/item/survey_handheld_rnd/elite
...
/obj/item/survey_handheld_rnd/exp
	name = "Experimental Survey Handheld"
	desc = "An improvement on even the Expert version; this handheld was designed to be VERY extremely fast in collecting data."
	icon_state = "survey-elite"
	survey_value = 650
...
/obj/item/survey_handheld_rnd/attack_self(mob/user)
	if(active)
		return
	...
	if((is_type_in_list(src_area, blacklist_area)) || src_turf.virtual_level_trait(ZTRAIT_STATION) || src_turf.virtual_level_trait(ZTRAIT_CENTCOM) || src_turf.virtual_level_trait(ZTRAIT_SCAN_DISRUPT))
		to_chat(user, span_notice("You cannot do this on restricted area!"))
		return
...
/datum/design/survey_handheld_rnd
	name = "Survey Handheld"
	id = "survey-handheld-rnd"
	build_type = AUTOLATHE
	build_path = /obj/item/survey_handheld_rnd
	materials = list(
...
/datum/design/survey_handheld_rnd_advanced
	name = "Advanced Survey Handheld"
	id = "survey-handheld-rnd-advanced"
	build_type = PROTOLATHE
	build_path = /obj/item/survey_handheld_rnd/advanced
	materials = list(
...
/datum/design/survey_handheld_rnd_elite
	name = "Elite Survey Handheld"
	id = "survey-handheld-rnd-elite"
	build_type = PROTOLATHE
	build_path = /obj/item/survey_handheld_rnd/elite
	materials = list(
...
/datum/design/survey_handheld_rnd_exp
	name = "Experimental Survey Handheld"
	id = "survey-handheld-rnd-exp"
	build_type = PROTOLATHE
	build_path = /obj/item/survey_handheld_rnd/exp
	materials = list(
		/datum/material/iron = 5000,
		/datum/material/silver = 5000,
		/datum/material/gold = 3000,
