...
/obj/item/melee/baseball_bat/homerun/central_command
	...
	icon = 'modular_mankind/_storage_icons/icons/items/weapons/centcom.dmi'
	lefthand_file = 'modular_mankind/_storage_icons/icons/items/weapons/in_hands/left_centcom.dmi'
	righthand_file = 'modular_mankind/_storage_icons/icons/items/weapons/in_hands/right_centcom.dmi'
