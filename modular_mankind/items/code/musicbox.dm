/obj/item/toy/musicbox
	...
	icon = 'modular_mankind/_storage_icons/icons/items/misc/musicbox.dmi'
	icon_state = "box_close"
	lefthand_file = 'modular_mankind/_storage_icons/icons/items/misc/in_hands/musicbox_hands_left.dmi'
	righthand_file = 'modular_mankind/_storage_icons/icons/items/misc/in_hands/musicbox_hands_right.dmi'
	usesound = 'modular_mankind/_storage_sounds/sound/items/musicbox.ogg'
