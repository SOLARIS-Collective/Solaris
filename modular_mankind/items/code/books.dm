/obj/item/elysm_manual
	...
	icon = 'modular_mankind/_storage_icons/icons/items/misc/book.dmi'
	lefthand_file = 'modular_mankind/_storage_icons/icons/items/misc/in_hands/books_lefthand.dmi'
	righthand_file = 'modular_mankind/_storage_icons/icons/items/misc/in_hands/books_righthand.dmi'
