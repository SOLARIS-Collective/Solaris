...
/obj/item/clothing/suit/toggle/armor/parade
	...
	icon = 'modular_mankind/_storage_icons/icons/items/clothing/suit/paradeformal.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/clothing/suit/overlay/paradeformal.dmi'
...
/obj/item/clothing/neck/cloak/cap
	icon = 'modular_mankind/_storage_icons/icons/items/clothing/suit/cloaks.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/clothing/suit/overlay/cloaks.dmi'
