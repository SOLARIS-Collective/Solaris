...
/obj/item/clothing/suit/armor/vest/capcarapace/syndievest
	icon = 'modular_mankind/_storage_icons/icons/items/clothing/suit/undersuits.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/clothing/suit/overlay/undersuits.dmi'
