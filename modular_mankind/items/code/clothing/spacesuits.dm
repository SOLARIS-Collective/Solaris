...
/obj/item/clothing/head/helmet/space/hardsuit/swat/captain
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/clothing/space_suit/overlay/caparmor_new.dmi'
	icon = 'modular_mankind/_storage_icons/icons/items/clothing/space_suit/capspacesuit_new.dmi'
