/obj/item/clothing/suit/hooded/cloak/padded
	...
	lefthand_file = 'modular_mankind/_storage_icons/icons/items/clothing/neck/in_hands/padded_left.dmi'
	righthand_file = 'modular_mankind/_storage_icons/icons/items/clothing/neck/in_hands/padded_right.dmi'
