/obj/item/clothing/under/dress/flower
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/clothing/suit/overlay/dress.dmi'
	icon = 'modular_mankind/_storage_icons/icons/items/clothing/suit/dress.dmi'
	name = "flower dress"
	desc = "Lovely dress."
