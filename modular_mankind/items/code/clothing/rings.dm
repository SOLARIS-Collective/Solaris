...
/obj/item/clothing/gloves/ring
	icon = 'modular_mankind/_storage_icons/icons/items/misc/ring.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/clothing/hands/overlay/hands2.dmi'
	name = "gold ring"
