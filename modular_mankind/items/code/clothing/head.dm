...
/obj/item/clothing/head/costume/tv_head
	...
	lefthand_file = 'modular_mankind/_storage_icons/icons/items/misc/in_hands/medical_lefthand.dmi' //Grandfathered in from the wallframe for status displays.
	righthand_file = 'modular_mankind/_storage_icons/icons/items/misc/in_hands/medical_righthand.dmi'
...
/obj/item/clothing/head/beret/dominia
	...
	icon = 'modular_mankind/_storage_icons/icons/items/clothing/head/beret.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/clothing/head/overlay/beret.dmi'
...
/obj/item/clothing/head/cap_navyblue
	...
	icon = 'modular_mankind/_storage_icons/icons/items/clothing/head/hats.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/clothing/head/overlay/head.dmi'
