...
/turf/open/lava/plasma_gaint
	...
	icon = 'modular_mankind/_storage_icons/icons/structures/turf/lava_plasma.dmi'
	icon_state = "lava-255"
	initial_gas_mix = PLASMA_GIANT_ATMOS
...
/turf/open/chasm/plasma
	...
	icon = 'modular_mankind/_storage_icons/icons/structures/turf/chasms_plasma.dmi'
...
/turf/open/floor/plating/asteroid/whitesands/earth
	name = "sand"
	initial_gas_mix = OPENTURF_DEFAULT_ATMOS
	icon = 'modular_mankind/_storage_icons/icons/structures/turf/beach.dmi'
	icon_state = "sand"
