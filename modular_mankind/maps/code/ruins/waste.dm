...
/datum/map_template/ruin/wasteplanet/claw_waste
	id = "claw_waste"
...
/datum/map_template/ruin/wasteplanet/lab
	id = "lab"
	name = "Abandoned Research Lab"
	description = "A research lab that was abandoned after a failed experiment."
...
/datum/map_template/ruin/wasteplanet/recyclebay
	id = "recyclebay"
	name = "Abandoned Recycle Bay"
	description = "A facility for recycling waste materials."
