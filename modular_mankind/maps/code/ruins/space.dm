/datum/map_template/ruin/space
	prefix = "_maps/_modular_solaris/RandomRuins/SpaceRuins/"
...
/datum/map_template/ruin/space/cryocontainment
	...
	suffix = "space_cryocontainment.dmm"
