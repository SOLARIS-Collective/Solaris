...
/datum/map_template/ruin/whitesands/survivors_combination
	id = "ws-combination"
...
/datum/map_template/ruin/whitesands/waterplant
	id = "waterplant"
	name = "Abandoned Water Plant"
	description = "A defunct water treatment facility, now overrun with vegetation."
