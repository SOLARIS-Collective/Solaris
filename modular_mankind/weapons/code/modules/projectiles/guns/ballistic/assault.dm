...
//Иконки
	...
	lefthand_file = 'modular_mankind/_storage_icons/icons/items/weapons/in_hands/guns_lefthand.dmi'
	righthand_file = 'modular_mankind/_storage_icons/icons/items/weapons/in_hands/guns_righthand.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/weapons/back.dmi'
	icon_state = "g36sh"
	item_state = "g36sh"
//Звуки
	fire_sound = 'modular_mankind/_storage_sounds/sound/gun/g36sh.ogg'
//Характеристики
...
/obj/item/gun/ballistic/automatic/assault/g36
	...
	righthand_file = 'modular_mankind/_storage_icons/icons/items/weapons/in_hands/guns_righthand.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/weapons/back.dmi'
	fire_sound = 'modular_mankind/_storage_sounds/sound/gun/g36.ogg'
	icon_state = "g36"
	item_state = "g36"
	manufacturer = MANUFACTURER_SOLARARMORIES
	spread = 2
...
/obj/item/gun/ballistic/automatic/assault/morita1
	...
	righthand_file = 'modular_mankind/_storage_icons/icons/items/weapons/in_hands/guns_righthand.dmi'
	icon = 'modular_mankind/_storage_icons/icons/items/weapons/48x32guns.dmi'
	fire_sound = 'modular_mankind/_storage_sounds/sound/gun/morita1.ogg'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/weapons/back.dmi'
	icon_state = "morita1"
	item_state = "morita1"
	spread = 3
...
/obj/item/gun/ballistic/automatic/marksman/svd
	...
	icon = 'modular_mankind/_storage_icons/icons/items/weapons/svd.dmi'
	lefthand_file = 'modular_mankind/_storage_icons/icons/items/weapons/in_hands/svd_lefthand.dmi'
	righthand_file = 'modular_mankind/_storage_icons/icons/items/weapons/in_hands/svd_righthand.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/weapons/overlay/svd_onmob.dmi'
	...
	rack_sound = 'modular_mankind/_storage_sounds/sound/gun/svd/svd_cocked.ogg'
