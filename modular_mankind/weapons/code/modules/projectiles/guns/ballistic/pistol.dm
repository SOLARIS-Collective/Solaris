/obj/item/gun/ballistic/automatic/pistol/usp45
	...
	icon = 'modular_mankind/_storage_icons/icons/items/weapons/usp.dmi'
	icon_state = "usp"
	...
	fire_sound = 'modular_mankind/_storage_sounds/sound/gun/shot_usp45.wav'
...
/obj/item/gun/ballistic/automatic/pistol/glock
	...
	icon = 'modular_mankind/_storage_icons/icons/items/weapons/glock.dmi'
	icon_state = "glock"
	...
	fire_sound = 'modular_mankind/_storage_sounds/sound/gun/shot_glock.wav'
...
/obj/item/gun/ballistic/automatic/pistol/solgov // - Оффы не завезли отображение в руках для этого пистолета, потому фиксим проблему так.
	...
	icon = 'modular_mankind/_storage_icons/icons/items/weapons/pistols.dmi'
