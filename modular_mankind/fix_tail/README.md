...
Фикс для хвостов таяр в спэйс-суйтах, теперь их не видно даже при *wag
<!--
...
- `code/modules/mob/living/carbon/human/emote.dm`: `/datum/emote/living/carbon/human/wag/run_emote(mob/user, params, type_override, intentional)`
- `code/modules/mob/living/carbon/human/species.dm`: `/datum/species/proc/handle_mutant_bodyparts(mob/living/carbon/human/H, forced_colour)`
<!--
...
- `code/__DEFINES/inventory.dm`: `HIDETAIL`
<!--
