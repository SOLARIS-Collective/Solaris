...
<!--
  ...
  Примеры: `code/__defines/~mod_mankind/silicon.dm`: `SILICON_SPEED_MULTIPLIER`, `SILICON_SPEED_BASE`
-->

### Используемые файлы, не содержащиеся в модпаке

- `mod_mankind/_storage_icons/icons/other/borgs/mekaborg.dmi` - Спрайты Мека боргов
<!--
