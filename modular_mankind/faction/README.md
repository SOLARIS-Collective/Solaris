...
## Фракции для шипов и оутфитов

ID мода: MANKIND_FACTION
<!--
...
Этот мод корректирует фракции под реалии целадона
<!--
...
- ADD `code\__DEFINES\~modular_mankind\access.dm`: `FACTION_PLAYER_ELYSIUM`
<!--
