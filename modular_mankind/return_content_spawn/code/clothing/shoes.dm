...
/obj/item/clothing/shoes/clown_shoes
	...
	icon = 'modular_mankind/_storage_icons/icons/items/clothing/feet/shoes.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/items/clothing/feet/overlay/feet.dmi'
	lefthand_file = 'modular_mankind/_storage_icons/icons/other/clown_mime/shoes_lefthand.dmi'
	righthand_file = 'modular_mankind/_storage_icons/icons/other/clown_mime/shoes_righthand.dmi'
	icon_state = "clown"
