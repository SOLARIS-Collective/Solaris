// SOLARIS-SPACEPOD: адаптация equipment.dm из PR 2039
// Пути иконок/звуков переведены с mod_celadon/_storge_* на modular_solaris/_storage_*

/obj/item/spacepod_equipment
	var/obj/spacepod/spacepod
	icon = 'modular_solaris/_storage_icons/icons/overlay/spacepods/parts.dmi'
...
/obj/item/spacepod_equipment/weaponry/proc/fire_weapons(target)
	if(spacepod.next_firetime > world.time)
		...
		playsound(src, 'modular_solaris/_storage_sounds/sound/effects/gun_dry_fire.ogg', 30, TRUE)
		return
...
/obj/item/spacepod_equipment/weaponry/disabler
	...
	overlay_icon = 'modular_solaris/_storage_icons/icons/overlay/spacepods/2x2.dmi'
...
/obj/item/spacepod_equipment/weaponry/basic_pod_ka
	...
	icon = 'modular_solaris/_storage_icons/icons/spacepods/parts.dmi'
