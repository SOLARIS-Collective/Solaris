...
- https://github.com/SOLARIS-Collective/Pentest/pulls/#####
<!--
...
<!--
  ...
  Примеры: `code/__defines/~modular_solaris/mobs.dm`: `MOBS_SPEED_MULTIPLIER`, `MOBS_SPEED_BASE`
-->
