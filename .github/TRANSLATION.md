...
* [Макросы для работы с переводами](code/__DEFINES/~modular_mankind/translation.dm)
...
Все макросы и примеры использования можно посмотреть [тут](code/__DEFINES/~modular_mankind/translation.dm), раздел "Местоимения(RU)"
