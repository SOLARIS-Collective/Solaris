...
Этот мод добавляет наши свои рецепты в крафт меню.
<!--
...
- EDIT: `code/game/objects/items/decal_painter.dm` - Добавляем в покрасчик полов текстурки
- ADD: ``code/game/objects/items/stacks/sheets/mineral.dm` - Добавляем рецепты
- ADD: `code/game/objects/items/stacks/sheets/sheet_types.dm` - Добавляем рецепты
- ADD: `code/game/objects/items/stacks/sheets/recipes/recipes_metal.dm` - Добавляем рецепты
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/crafting_recipe.dm`: `CRAFTING_RECIPE_SPEED_MULTIPLIER`, `CRAFTING_RECIPE_SPEED_BASE`
-->
