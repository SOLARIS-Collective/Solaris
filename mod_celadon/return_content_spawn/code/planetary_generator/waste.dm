/datum/biome/waste/metal
	mob_spawn_list = list( //nor organics, more biased towards hivebots though
		...
		/obj/structure/spawner/hivebot/low_threat = 20,
		/obj/structure/spawner/hivebot/medium_threat = 10,
		/obj/structure/spawner/hivebot/high_threat = 5,
		/obj/structure/spawner/hivebot/extreme_threat = 2,
