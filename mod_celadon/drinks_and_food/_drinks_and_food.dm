...
/datum/modpack/drinks_and_food
	name = "Выпивка и еда"
	desc = "Добавляет и расширяет ассортименты коктелей, еды и прочих вещей связанных с едой"
	author = "MrCat15352"
...
// Инициализация ДО
// /datum/modpack/drinks_and_food/pre_initialize()
// 	. = ..()

// // Инициализация ВОВРЕМЯ
// /datum/modpack/drinks_and_food/initialize()
// 	. = ..()

// // Инициализация ПОСЛЕ
// /datum/modpack/drinks_and_food/post_initialize()
// 	. = ..()
