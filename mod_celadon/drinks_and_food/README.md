...
ID мода: CELADON_DRINKS_AND_FOOD
<!--
...
Этот мод добавляет и расширяет ассортименты коктелей, еды и прочих вещей связанных с едой.
<!--
...
- ADD: `code/game/objects/effects/spawners/random/food_or_drink.dm`
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/drinks_and_food.dm`: `DRINKS_AND_FOOD_SPEED_MULTIPLIER`, `DRINKS_AND_FOOD_SPEED_BASE`
-->
