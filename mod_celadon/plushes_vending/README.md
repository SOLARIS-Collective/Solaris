...
ID мода: CELADON_PLUSHES_VENDING
<!--
...
Добавляет машинерию содержащую все игрушки добавленные на Целадон, не за бесплатно конечно же.
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/plushes_vending.dm`: `PLUSHES_VENDING_SPEED_MULTIPLIER`, `PLUSHES_VENDING_SPEED_BASE`
-->
