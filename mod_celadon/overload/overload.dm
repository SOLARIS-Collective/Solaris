...
/datum/modpack/overload
	name = "OVERLOAD - Механика перегрузок"
	desc = "Добавляет механику перегрузки для ускорения."
	author = "vagabond05"
...
// Инициализация ДО
/datum/modpack/overload/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/overload/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/overload/post_initialize()
	. = ..()
