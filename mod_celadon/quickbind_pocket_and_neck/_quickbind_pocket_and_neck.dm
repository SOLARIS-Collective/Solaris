...
/datum/modpack/quickbind_pocket_and_neck
	name = "quickbind_pocket_and_neck"
	desc = "Этот мод добавляет в билд хоткей для левого и правого кармана, так же для шеи."
	author = "Myakotka"
...
// Инициализация ДО
/datum/modpack/quickbind_pocket_and_neck/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/quickbind_pocket_and_neck/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/quickbind_pocket_and_neck/post_initialize()
	. = ..()
