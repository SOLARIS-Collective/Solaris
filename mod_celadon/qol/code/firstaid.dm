/obj/item/storage/firstaid/synthflesh
	...
	icon = 'mod_celadon/_storage_icons/icons/items/misc/storage.dmi'
	icon_state = "synthflesh"
	lefthand_file = 'mod_celadon/_storage_icons/icons/items/misc/in_hands/storage_hands_left.dmi'
	righthand_file = 'mod_celadon/_storage_icons/icons/items/misc/in_hands/storage_hands_right.dmi'
