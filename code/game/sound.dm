...
// [/MANKIND-ADD]
			...
			// [MANKIND-ADD] - MANKIND_WEAPONS - добавляем рандомизацию звуков при выстреле
			if("svd_fire")
				soundin = pick('modular_mankind/_storage_sounds/sound/gun/svd/svd1.ogg', 'modular_mankind/_storage_sounds/sound/gun/svd/svd2.ogg', 'modular_mankind/_storage_sounds/sound/gun/svd/svd3.ogg')
			// [/MANKIND-ADD] - MANKIND_WEAPONS
	return soundin
