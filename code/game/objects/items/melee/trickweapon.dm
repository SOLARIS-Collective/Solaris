...
/obj/item/melee/cleaving_saw/Initialize(mapload)
	...
	)	//add: hitsound_on = hitsound, \ // [MANKIND-ADD] - FIXES_SOUND - Фикс бага на звук лазерного меча
...
// [MANKIND-EDIT] - FIXES_SOUND - Изменены звуки раскрытия/закрытия
//	playsound(user, 'sound/magic/clockwork/fellowship_armory.ogg', 35, TRUE, frequency = 90000 - (active * 30000))
	playsound(user, active ? 'modular_mankind/_storage_sounds/sound/weapons/cleaving_saw_open.ogg' : 'modular_mankind/_storage_sounds/sound/weapons/cleaving_saw_close.ogg', 35, TRUE, frequency = 90000 - (active * 30000))
// [/MANKIND-EDIT]
