...
/obj/structure/table_frame/wood/attackby(obj/item/I, mob/user, params)
	if (istype(I, /obj/item/stack))
		...
		if(istype(I, /obj/item/stack/sheet/mineral/wood))
			...
			// [MANKIND-EDIT] - MANKIND_STRUCTURES - Пока так, у нас нет варианта усиленого материала дерева
			// toConstruct = /obj/structure/table/wood/reinforced	// ORIGINAL
			...
			// [/MANKIND-EDIT]
		// [MANKIND-ADD] - MANKIND_STRUCTURES
