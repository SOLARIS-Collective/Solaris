...
/obj/item/bedsheet/mime
	...
	icon = 'modular_mankind/_storage_icons/icons/other/clown_mime/bedsheets.dmi'
	lefthand_file = 'modular_mankind/_storage_icons/icons/other/clown_mime/bedsheet_lefthand.dmi'
	righthand_file = 'modular_mankind/_storage_icons/icons/other/clown_mime/bedsheet_righthand.dmi'
