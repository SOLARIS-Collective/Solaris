...
/obj/machinery/computer/operating/ui_data(mob/user)
	...
	data["patient"]["blood_type"] = patient.get_blood_type_display()
	// [/MANKIND-EDIT]
	data["patient"]["blood_volume"] = "[round((patient.blood_volume / BLOOD_VOLUME_NORMAL)*100)] %, [patient.blood_volume] cl" // [MANKIND-ADD] Добавляем значение кол-ва крови в терминал операций: tgui\packages\tgui\interfaces\OperatingComputer.js
