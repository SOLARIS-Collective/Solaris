...
// [MANKIND-EDIT] - MANKIND_NEW_AUGMENTS_STYLE - New Style Augments
	// var/static/list/style_list_icons = list("standard" = 'icons/mob/augmentation/augments.dmi', "engineer" = 'icons/mob/augmentation/augments_engineer.dmi', "security" = 'icons/mob/augmentation/augments_security.dmi', "mining" = 'icons/mob/augmentation/augments_mining.dmi')	// ORIGINAL
	var/static/list/style_list_icons = list("standard" = 'icons/mob/augmentation/augments.dmi', "engineer" = 'icons/mob/augmentation/augments_engineer.dmi', "security" = 'icons/mob/augmentation/augments_security.dmi', "mining" = 'icons/mob/augmentation/augments_mining.dmi', "bishop" = 'modular_mankind/_storage_icons/icons/mobs/augmentation/augments_bishop.dmi', "shellguard" = 'modular_mankind/_storage_icons/icons/mobs/augmentation/augments_shellguard.dmi', "wardtakahashi" = 'modular_mankind/_storage_icons/icons/mobs/augmentation/augments_wardtakahashi.dmi', "xion" = 'modular_mankind/_storage_icons/icons/mobs/augmentation/augments_xion.dmi', "zenghu" = 'modular_mankind/_storage_icons/icons/mobs/augmentation/augments_zenghu.dmi')
	var/static/list/style_list_icons_bonus = style_list_icons + list("digitigrade" = 'modular_mankind/_storage_icons/icons/mobs/augmentation/digitigrade_legs.dmi')
// [/MANKIND-EDIT]
...
/obj/machinery/aug_manipulator/attack_hand(mob/user)
	...
	if(storedpart)
		...
		// if(!storedpart)
		// 	return
		// storedpart.static_icon = style_list_icons[augstyle]	// ORIGINAL
