...
/obj/item/clothing/suit/space/hardsuit/ert/lp
	...
	armor = list("melee" = 50, "bullet" = 50, "laser" = 30, "energy" = 40, "bomb" = 35, "bio" = 100, "rad" = 60, "fire" = 50, "acid" = 80, "wound" = 30)  // [MANKIND-EDIT] - MANKIND_BALANCE
...
/obj/item/clothing/head/helmet/space/hardsuit/ert/lp
	armor = list("melee" = 50, "bullet" = 40, "laser" = 30, "energy" = 40, "bomb" = 35, "bio" = 100, "rad" = 60, "fire" = 50, "acid" = 80, "wound" = 30)  // [MANKIND-EDIT] - MANKIND_BALANCE
...
/obj/item/clothing/suit/space/hardsuit/ert/lp/sec
	armor = list("melee" = 40, "bullet" = 40, "laser" = 20, "energy" = 20, "bomb" = 20, "bio" = 100, "rad" = 50, "fire" = 40, "acid" = 40, "wound" = 30)  // [MANKIND-EDIT] - MANKIND_BALANCE
...
/obj/item/clothing/suit/space/hardsuit/ert/lp/engi
	armor = list("melee" = 30, "bullet" = 20, "laser" = 30, "energy" = 30, "bomb" = 25, "bio" = 100, "rad" = 75, "fire" = 90, "acid" = 75, "wound" = 20)  // [MANKIND-EDIT] - MANKIND_BALANCE
...
/obj/item/clothing/head/helmet/space/hardsuit/ert/lp/engi
	armor = list("melee" = 38, "bullet" = 20, "laser" = 30, "energy" = 30, "bomb" = 25, "bio" = 100, "rad" = 75, "fire" = 90, "acid" = 75, "wound" = 20)  // [MANKIND-EDIT] - MANKIND_BALANCE
...
/obj/item/clothing/suit/space/hardsuit/ert/lp/med
	armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 25, "bomb" = 25, "bio" = 100, "rad" = 60, "fire" = 60, "acid" = 60, "wound" = 20)  // [MANKIND-EDIT] - MANKIND_BALANCE
...
/obj/item/clothing/head/helmet/space/hardsuit/lp
	...
	armor = list("melee" = 5, "bullet" = 5, "laser" = 1, "energy" = 1, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 75, "wound" = 10)  // [MANKIND-EDIT] - MANKIND_BALANCE
