/turf/open/floor/plating/asteroid/snow
	...
	name = "snow"
	desc = "Looks cold."
	icon = MAP_SWITCH('icons/turf/floors/snow.dmi', 'modular_mankind/_storage_icons/icons/structures/snow.dmi') // [MANKIND-EDIT] - Снег без квадратиков в sDMM
	...
	//MAP_SWITCH(pixel_x = 0, pixel_x = -19)	// [MANKIND-EDIT] - Снег без квадратиков в sDMM, это конечно круто но зачем...
	//MAP_SWITCH(pixel_y = 0, pixel_y = -19)	// [/MANKIND-EDIT]
