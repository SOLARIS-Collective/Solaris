...
/datum/ai_controller/monkey
	...
	blackboard = list(
		...
		BB_MONKEY_WEAPON_PICKUP_COOLDOWN = 0,	// [MANKIND-ADD] - FIXES_MONKEY_STOPPED_SPEEDUP
...
/datum/ai_controller/monkey/able_to_run()
	...
	// [MANKIND-EDIT] - FIXES_MONKEY_STOPPED_DEAD - Отрубаем ИИшку если макака полностью померла
...
/datum/ai_controller/monkey/proc/TryFindWeapon()
	...
	set_blackboard_key(BB_MONKEY_WEAPON_PICKUP_COOLDOWN, world.time + 1 SECONDS)	// [MANKIND-ADD] - FIXES_MONKEY_STOPPED_SPEEDUP
