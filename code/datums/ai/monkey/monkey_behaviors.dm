...
/datum/ai_behavior/monkey_equip/finish_action(datum/ai_controller/controller, success)
	...
	var/obj/item/target = controller.blackboard[BB_MONKEY_PICKUPTARGET]	// [MANKIND-ADD] - FIXES_MONKEY_STOPPED_SPEEDUP
	// [MANKIND-EDIT] - FIXES_MONKEY_STOPPED_SPEEDUP
	...
	// [MANKIND-EDIT]
		...
		// var/obj/item/target = controller.blackboard[BB_MONKEY_PICKUPTARGET]	// [MANKIND-REMOVE] - FIXES_MONKEY_STOPPED_SPEEDUP
...
/datum/ai_behavior/monkey_equip/proc/equip_item(datum/ai_controller/controller)
	...
	// [MANKIND-ADD] - FIXES_MONKEY_STOPPED_SPEEDUP
...
/datum/ai_behavior/monkey_equip/ground/perform(seconds_per_tick, datum/ai_controller/controller)
	return equip_item(controller)	// [MANKIND-ADD] - FIXES_MONKEY_STOPPED_SPEEDUP
...
/datum/ai_behavior/monkey_equip/pickpocket/perform(seconds_per_tick, datum/ai_controller/controller)
	...
	if(controller.blackboard[BB_MONKEY_PICKPOCKETING]) //We are pickpocketing, don't do ANYTHING!!!!
		return AI_BEHAVIOR_DELAY	// [MANKIND-ADD] - FIXES_MONKEY_STOPPED_SPEEDUP
...
/datum/ai_behavior/monkey_equip/pickpocket/proc/attempt_pickpocket(datum/ai_controller/controller)
	...
	// [MANKIND-ADD] - FIXES_MONKEY_STOPPED_PICKPOCKET - Предотвращаем ошибку, когда макака пытается украсть предмет с пола
	if(!isliving(victim))
		return AI_BEHAVIOR_DELAY | AI_BEHAVIOR_FAILED
	// [/MANKIND-ADD]
