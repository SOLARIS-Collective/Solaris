/*
	PENTEST ADDITION - GLASS TRANSPARENCY FIX PR#288
	If you see a merge conflict here, it is probably safer to keep our version of the code.
	A ton of this changed and I am literally not going to denote each line with a comment.
*/
