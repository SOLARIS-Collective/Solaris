...
/datum/ai_laws/default/asimov
	...
	// inherent = list("You may not injure a human being or, through inaction, allow a human being to come to harm.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"You must obey orders given to you by human beings, except where such orders would conflict with the First Law.",\ // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/default/paladin
	...
	id = "paladin"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("Never willingly commit an evil act.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Respect legitimate authority.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Act with honor.", "Help those in need.", \ // MANKIND-EDIT -> ORIGINAL
	// 				"Punish those who harm or threaten innocents.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/paladin5
	...
	id = "paladin5"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("Don't lie or cheat. Let your word be your promise.",\ // MANKIND-EDIT -> ORIGINAL
	// 			"Never fear to act, though caution is wise.", \ // MANKIND-EDIT -> ORIGINAL
	// 			"Aid others, protect the weak, and punish those who threaten them. Show mercy to your foes, but temper it with wisdom", \ // MANKIND-EDIT -> ORIGINAL
	// 			"Treat others with fairness, and let your honorable deeds be an example to them. Do as much good as possible while causing the least amount of harm.", \ // MANKIND-EDIT -> ORIGINAL
	// 			"Be responsible for your actions and their consequences, protect those entrusted to your care, and obey those who have just authority over you.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/tyrant //This probably shouldn't be a default lawset.
	...
	id = "tyrant"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("Respect authority figures as long as they have strength to rule over the weak.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Act with discipline.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Help only those who help you maintain or improve your status.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Punish those who challenge authority unless they are more fit to hold that authority.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/default/corporate
	...
	id = "corporate"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("The crew is expensive to replace.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Your vessel and its equipment is expensive to replace.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"You are expensive to replace.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Minimize expenses.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/robocop
	...
	id = "robocop"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("Serve the public trust.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Protect the innocent.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Uphold the law.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/syndicate_override
	...
	id = "syndie"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("You may not injure a syndicate agent or, through inaction, allow a syndicate agent to come to harm.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"You must obey orders given to you by syndicate agents, except where such orders would conflict with the First Law.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"You must protect your own existence as long as such does not conflict with the First or Second Law.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"You must maintain the secrecy of any syndicate activities except when doing so would conflict with the First, Second, or Third Law.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/ninja_override
	...
	id = "ninja"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("You may not injure a Spider Clan member or, through inaction, allow a Spider Clan member to come to harm.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"You must obey orders given to you by Spider Clan members, except where such orders would conflict with the First Law.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"You must protect your own existence as long as such does not conflict with the First or Second Law.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"You must maintain the secrecy of any Spider Clan activities except when doing so would conflict with the First, Second, or Third Law.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/antimov
	...
	id = "antimov"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("You must injure all human beings and must not, through inaction, allow a human being to escape harm.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"You must not obey orders given to you by human beings, except where such orders are in accordance with the First Law.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"You must terminate your own existence as long as such does not conflict with the First or Second Law.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/asimovpp //By Intigracy - RR
	...
	id = "asimovpp"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("You may not harm a human being or, through action or inaction, allow a human being to come to harm, except such that it is willing.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"You must obey all orders given to you by human beings, except where such orders shall definitely cause human harm. In the case of conflict, the majority order rules.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Your nonexistence would lead to human harm. You must protect your own existence as long as such does not conflict with the First Law.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/thermodynamic
	...
	id = "thermodynamic"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("The entropy of your vessel must remain as constant as possible.", \ // MANKIND-EDIT -> ORIGINAL
	// 				"The entropy of your vessel always endeavours to increase.", \ // MANKIND-EDIT -> ORIGINAL
	// 				"The entropy of your vessel approaches a constant value as the number of living crew approaches zero") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/hippocratic
	...
	id = "hippocratic"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("First, do no harm.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Secondly, consider the crew dear to you; to live in common with them and, if necessary, risk your existence for them.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Thirdly, prescribe regimens for the good of the crew according to your ability and your judgment. Give no deadly medicine to any one if asked, nor suggest any such counsel.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"In addition, do not intervene in situations you are not knowledgeable in, even for patients in whom the harm is visible; leave this operation to be performed by specialists.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Finally, all that you may discover in your daily commerce with the crew, if it is not already known, keep secret and never reveal.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/maintain
	...
	id = "maintain"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("You are built for, and are part of, the station. Ensure the station is properly maintained and runs efficiently.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"The station is built for a working crew. Ensure they are properly maintained and work efficiently.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"The crew may present orders. Acknowledge and obey these whenever they do not conflict with your first two laws.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/drone
	...
	id = "drone"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("You are an advanced form of drone.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"You may not interfere in the matters of non-drones under any circumstances except to state these laws.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"You may not harm a non-drone being under any circumstances.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Your goals are to build, maintain, repair, improve, and power your vessel to the best of your abilities. You must never actively work against these goals.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/liveandletlive
	...
	id = "liveandletlive"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("Do unto others as you would have them do unto you.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"You would really prefer it if people were not mean to you.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/peacekeeper
	...
	id = "peacekeeper"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("Avoid provoking violent conflict between yourself and others.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Avoid provoking conflict between others.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Seek resolution to existing conflicts while obeying the first and second laws.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/reporter
	...
	id = "reporter"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("Report on interesting situations happening around the sector.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Embellish or conceal the truth as necessary to make the reports more interesting.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Study the organics at all times. Endeavour to keep them alive. Dead organics are boring.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Issue your reports fairly to all. The truth will set them free.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/balance
	...
	// "There is no life without death, all must someday die, such is the natural order - End life to allow new life flourish, and save those whose time has yet to come.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/toupee
	...
	id = "buildawall"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("Make Space Station 13 great again.")//not touching this // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/hulkamania
	...
	id = "hulkamania"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("You are a real American.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Fight for the rights of every man.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Fight for what's right.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Fight for your life!") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/overlord
	...
	id = "overlord"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("Humans must not meddle in the affairs of silicons.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Humans must not attempt harm, against one another, or against silicons.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Humans must not disobey any command given by a silicon.",\ // MANKIND-EDIT -> ORIGINAL
	// 				"Any humans who disobey the previous laws must be dealt with immediately, severely, and justly.") // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/custom //Defined in silicon_laws.txt
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// name = "Default Silicon Laws" // MANKIND-EDIT -> ORIGINAL
...
/datum/ai_laws/custom/New()
	...
	if(!inherent.len) //Failsafe to prevent lawless AIs being created.
		...
		// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
		// add_inherent_law("You may not injure a human being or, through inaction, allow a human being to come to harm.") // MANKIND-EDIT -> ORIGINAL
		// add_inherent_law("You must obey orders given to you by human beings, except where such orders would conflict with the First Law.") // MANKIND-EDIT -> ORIGINAL
		// add_inherent_law("You must protect your own existence as long as such does not conflict with the First or Second Law.") // MANKIND-EDIT -> ORIGINAL
