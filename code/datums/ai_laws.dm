...
/datum/ai_laws/balance
	...
	// "There is no life without death, all must someday die, such is the natural order - End life to allow new life flourish, and save those whose time has yet to come.") // ORIGINAL
...
/datum/ai_laws/toupee
	...
	id = "buildawall"
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// inherent = list("Make Space Station 13 great again.")//not touching this // ORIGINAL
...
/datum/ai_laws/custom //Defined in silicon_laws.txt
	// [MANKIND-EDIT] - MANKIND_QOL - Перевод законов ИИ
	// name = "Default Silicon Laws" // ORIGINAL
...
/datum/ai_laws/custom/New()
	...
	if(!inherent.len) //Failsafe to prevent lawless AIs being created.
		...
		// add_inherent_law("You must protect your own existence as long as such does not conflict with the First or Second Law.") // ORIGINAL
