...
/datum/component/storage/concrete/_removal_reset(atom/movable/thing)
	...
	// [MANKIND-ADD] - FIXES_ICON_OUT_OF_BORDER - Сбрасываем позицию элемента для предотвращения визуальных багов
...
/datum/component/storage/concrete/handle_item_insertion(obj/item/I, prevent_warning = FALSE, mob/M, datum/component/storage/remote)		//Remote is null or the slave datum
	...
	I.item_flags |= IN_STORAGE
	// [MANKIND-ADD] - FIXES_ICON_OUT_OF_BORDER - Сбрасываем позицию элемента при помещении в хранилище
	I.pixel_x = 0
	I.pixel_y = 0
	I.screen_loc = null
	// [/MANKIND-ADD]
