...
/datum/component/edible/proc/check_liked(fraction, mob/eater)
	...
	if(!food_taste_reaction)
		...
		// [MANKIND-ADD] - FIXES_PIZZABOX_AND_PIZZA - Плотоядные расы (Риолы и Таяраны) могут есть мясную пиццу, даже если она содержит нелюбимые ингредиенты
