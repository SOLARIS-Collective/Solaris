...
*/
	...
	if(!icon_exists('modular_mankind/_storage_icons/icons/resprite/hud/hud.dmi', "hud[initial(to_equip.outfit.faction_icon)]"))
		return FALSE

	var/icon/hudicon = icon('modular_mankind/_storage_icons/icons/resprite/hud/hud.dmi', "hud[initial(to_equip.outfit.faction_icon)]")
	hudicon.Blend(icon('modular_mankind/_storage_icons/icons/resprite/hud/hud.dmi', "hud[initial(to_equip.outfit.job_icon)]"), ICON_OVERLAY)
// [/MANKIND-EDIT]
