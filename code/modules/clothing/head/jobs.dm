...
// [MANKIND-EDIT] - MANKIND_BALANCE - броня хосовских шапок переопределена в modular_mankind\balance\code\items.dm
...
// [MANKIND-EDIT] - MANKIND_BALANCE - броня /obj/item/clothing/head/cowboy/sec переопределена в modular_mankind\balance\code\items.dm
...
// [MANKIND-EDIT] - MANKIND_BALANCE - броня /obj/item/clothing/head/warden переопределена в modular_mankind\balance\code\items.dm
