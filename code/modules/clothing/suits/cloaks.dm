...
/obj/item/clothing/suit/hooded/cloak/drake
	...
	armor = list("melee" = 50, "bullet" = 10, "laser" = 40, "energy" = 50, "bomb" = 50, "bio" = 60, "rad" = 50, "fire" = 100, "acid" = 100, "wound" = 50)  // [MANKIND-EDIT] - MANKIND_BALANCE
...
/obj/item/clothing/suit/hooded/cloak/bone
	...
	armor = list("melee" = 40, "bullet" = 25, "laser" = 30, "energy" = 30, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50, "wound" = 20)  // [MANKIND-EDIT] - MANKIND_BALANCE
