...
/obj/item/clothing/head/helmet/space/hardsuit/deathsquad
	...
	armor = list("melee" = 80, "bullet" = 80, "laser" = 50, "energy" = 60, "bomb" = 100, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 100, "wound" = 60)  // [MANKIND-EDIT] - MANKIND_BALANCE
	strip_delay = 130
...
/obj/item/clothing/suit/space/swat
	...
	item_state = "swat_suit"
	allowed = list(/obj/item/gun, /obj/item/ammo_box, /obj/item/ammo_casing, /obj/item/melee/baton, /obj/item/restraints/handcuffs, /obj/item/tank/internals, /obj/item/melee/knife/combat)
	armor = list("melee" = 40, "bullet" = 30, "laser" = 30,"energy" = 40, "bomb" = 50, "bio" = 90, "rad" = 20, "fire" = 100, "acid" = 100, "wound" = 20)  // [MANKIND-EDIT] - MANKIND_BALANCE
	strip_delay = 120
	resistance_flags = FIRE_PROOF | ACID_PROOF
...
/obj/item/clothing/head/helmet/space/pirate
	...
	icon_state = "pirate"
	item_state = "pirate"
	armor = list("melee" = 30, "bullet" = 50, "laser" = 30,"energy" = 40, "bomb" = 30, "bio" = 30, "rad" = 30, "fire" = 60, "acid" = 75, "wound" = 30)  // [MANKIND-EDIT] - MANKIND_BALANCE
	flags_inv = HIDEHAIR
	strip_delay = 40
...
/obj/item/clothing/head/helmet/space/hardsuit/ert
	...
	armor = list("melee" = 65, "bullet" = 50, "laser" = 50, "energy" = 60, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 80, "acid" = 80, "wound" = 50)  // [MANKIND-EDIT] - MANKIND_BALANCE
	strip_delay = 130
	light_range = 7
...
/obj/item/clothing/suit/space/hardsuit/ert
	...
	resistance_flags = FIRE_PROOF
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
	supports_variations = DIGITIGRADE_VARIATION	// [MANKIND-ADD]
...
/obj/item/clothing/suit/space/hardsuit/ert/clown
	...
	icon = 'modular_mankind/_storage_icons/icons/other/clown_mime/spacesuits.dmi'
	mob_overlay_icon = 'modular_mankind/_storage_icons/icons/other/clown_mime/spacesuits_on_mob.dmi'
...
/obj/item/clothing/suit/space/hardsuit/berserker
	...
	armor = list("melee" = 30, "bullet" = 10, "laser" = 10, "energy" = 20, "bomb" = 10, "bio" = 100, "rad" = 10, "fire" = 100, "acid" = 100, "wound" = 30)  // [MANKIND-EDIT] - MANKIND_BALANCE
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
	resistance_flags = FIRE_PROOF
