...
/datum/round_event/wizard/deprevolt/start()
	...
	switch(tidecolor)
		...
		if("whatevercolorrepresentstheservicepeople") //the few, the proud, the technically aligned
			jobs_to_revolt = list("Bartender", "Cook", "Botanist", "Clown", "Mime", "Janitor", "Chaplain")	//jobs_to_revolt = list("Bartender", "Cook", "Botanist", "Janitor", "Chaplain")	// [CELADON-ADD] - CELADON_RETURN_CONTENT_CLOWNS
