					...
					switch(rand(1,2)) //Change whose job?
						if(1) //Change the entire crew's job
							switch(rand(1,3)) //Change to what?
								if(1) //Change to a specific random job	//if(1)	// [CELADON-ADD] - CELADON_RETURN_CONTENT_CLOWNS
...
// [/CELADON-ADD]
						...
						if(2) //Change a specific crewmember's job
							switch(rand(1,3)) //Change to what?
								if(1) //Change to a specific random job	//if(1 to 2)	// [CELADON-ADD] - CELADON_RETURN_CONTENT_CLOWNS
