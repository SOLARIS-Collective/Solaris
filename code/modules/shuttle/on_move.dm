...
/turf/proc/onShuttleMove(turf/newT, list/movement_force, move_dir, shuttle_layers)
	...
	SEND_SIGNAL(newT, COMSIG_TURF_INITIALIZE_TRANSPARENCY) // PENTEST ADDITION - GLASS TRANSPARENCY FIX PR#288  - After baseturfs ares established, we send this signal. Deferred to here on travel, otherwise usually performed in ChangeTurf().
