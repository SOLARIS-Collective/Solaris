...
/mob/living/simple_animal/hostile/megafauna/demonic_frost_miner
	...
	move_to_delay = 20
	ranged = TRUE
	//mob_trophy = /obj/item/mob_trophy/ice_block_talisman		// [MANKIND-EDIT] - RETURN_CONTENT_CRUSHER_TROPHY
	crusher_loot = /obj/item/crusher_trophy/ice_block_talisman	// [/MANKIND-EDIT]
