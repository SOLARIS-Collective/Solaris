...
/datum/species/proc/handle_hair(mob/living/carbon/human/H, forced_colour)
	...
	if(H.facial_hairstyle && (FACEHAIR in species_traits) && !facialhair_hidden)
		...
		// S = GLOB.facial_hairstyles_list[H.facial_hairstyle] // ORIGINAL
	...
	if(!hair_hidden)
		...
		if(!hair_hidden && !H.getorgan(/obj/item/organ/brain)) //Applies the debrained overlay if there is no brain
			...
			// [MANKIND-EDIT] - TAJARA - изменения базы
			// S = GLOB.hairstyles_list[H.hairstyle] // ORIGINAL
...
/datum/species/proc/handle_mutant_bodyparts(mob/living/carbon/human/H, forced_colour)
	...
	// [MANKIND-ADD] - MANKIND_INTEQ_VENDOR - добавлена поддержка модами скрытия рогов Эльзоуз
	...
	for(var/layer in relevent_layers)
		...
		for(var/bodypart in bodyparts_to_add)
			...
			// [MANKIND-ADD] - TAJARA - add лучше чем edit
	...
	switch(slot)
		...
		if(ITEM_SLOT_SUITSTORE)
			...
			if(HAS_TRAIT(I, TRAIT_FORCE_SUIT_STORAGE))
				if(!H.w_uniform && !H.wear_suit)	// [MANKIND-EDIT]
					if(!disable_warning)
						to_chat(H, span_warning("You need at least a uniform or armor before you can attach this [I.name]!")) // [MANKIND-EDIT]
					return FALSE
				return TRUE
			if(!H.wear_suit)
				if(!disable_warning)
...
// [MANKIND-EDIT] - MANKIND_LANIUS
	// switch(H.nutrition) // [MANKIND-EDIT] - ORIGINAL
	// 	if(NUTRITION_LEVEL_HUNGRY to INFINITY)
	// 		H.clear_alert("nutrition")
	// 	if(NUTRITION_LEVEL_STARVING to NUTRITION_LEVEL_HUNGRY)
	// 		H.throw_alert("nutrition", /atom/movable/screen/alert/hungry)
	// 	if(0 to NUTRITION_LEVEL_STARVING)
	// 		H.throw_alert("nutrition", /atom/movable/screen/alert/starving) // [/MANKIND-EDIT] - ORIGINAL
	switch(H.nutrition)
		if(NUTRITION_LEVEL_HUNGRY to INFINITY)
			H.clear_alert("nutrition")
		if(NUTRITION_LEVEL_STARVING to NUTRITION_LEVEL_HUNGRY)
...
/datum/species/proc/harm(mob/living/carbon/human/user, mob/living/carbon/human/target, datum/martial_art/attacker_style)
	...
	if(attacker_style && attacker_style.harm_act(user,target))
		...
		// [MANKIND-ADD] MANKIND_BITE_FERAL
		...
		// [MANKIND-EDIT] MANKIND_BITE_FERAL
		//var/damage = rand(user.dna.species.punchdamagelow, user.dna.species.punchdamagehigh) // ORIGINAL
...
/datum/species/proc/spec_attack_hand(mob/living/carbon/human/M, mob/living/carbon/human/H, datum/martial_art/attacker_style)
	...
	// [MANKIND-EDIT] A little martial arts buff
...
/datum/species/proc/is_wagging_tail(mob/living/carbon/human/H)
	...
	// return ("waggingtail_human" in mutant_bodyparts) || ("waggingtail_lizard" in mutant_bodyparts) || ("waggingtail_elzu" in mutant_bodyparts) // ORIGINAL
