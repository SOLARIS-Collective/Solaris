...
/obj/item/seeds/peas/laugh
	...
	reagents_add = list (/datum/reagent/consumable/laughter = 0.05, /datum/reagent/consumable/sugar = 0.05, /datum/reagent/consumable/nutriment = 0.07)	//reagents_add = list (/datum/reagent/consumable/sugar = 0.05, /datum/reagent/consumable/nutriment = 0.07)	// [CELADON-ADD] - CELADON_RETURN_CONTENT_CLOWNS
