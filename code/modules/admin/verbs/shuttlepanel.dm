/datum/admins/proc/open_shuttlepanel()
	...
	log_mankind_admin("\[SHUTTLE]: [key_name(usr)] oppened Shuttle Manipulator.") // [MANKIND_ADD] - logging admin actions.
...
/obj/docking_port/mobile/proc/admin_fly_shuttle(mob/user)
	...
	switch(selection)
		if("Infinite Transit")
			...
			log_mankind_admin("\[SHUTTLE]: [user] has placed [name] into Infinite Transit.") // [MANKIND_ADD] - logging admin actions.
		...
		if("Delete Shuttle")
			...
			log_mankind_admin("\[SHUTTLE]: [user] has deleted [name].") // [MANKIND_ADD] - logging admin actions.
