...
/datum/admins/proc/Game()
	...
	log_mankind_admin("ADMIN: [key_name(usr)] has entered Game Panel.") // [MANKIND_ADD] - logging admin actions.
...
/datum/admins/proc/spawn_atom(object as text)
	...
	log_mankind_admin("ADMIN: [key_name(usr)] spawned [amount] x [chosen] at [AREACOORD(usr)]") // [MANKIND_ADD] - logging admin actions.
...
/datum/admins/proc/podspawn_atom(object as text)
	...
	log_mankind_admin("ADMIN: [key_name(usr)] pod-spawned [chosen] at [AREACOORD(usr)]") // [MANKIND_ADD] - logging admin actions.
...
/datum/admins/proc/spawn_cargo(object as text)
	...
	log_mankind_admin("ADMIN: [key_name(usr)] spawned cargo pack [chosen] at [AREACOORD(usr)]") // [MANKIND_ADD] - logging admin actions.
...
/datum/admins/proc/view_manifest()
	...
	log_mankind_admin("ADMIN: [key_name(usr)] openned the crew manifest UI.") // [MANKIND_ADD] - logging admin actions.
