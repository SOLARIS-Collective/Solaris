...
/obj/item/gun/energy/laser/retro
	...
	manufacturer = MANUFACTURER_SHARPLITE
	default_ammo_type = /obj/item/stock_parts/cell/gun // [MANKIND-EDIT]-исправление некоректного магазина OLD CODE: default_ammo_type = /obj/item/stock_parts/cell/gun/sharplite
