...
#define ZAP_MAJOR_STORM_FLAGS ZAP_STORM_FLAGS | ZAP_GIVES_RESEARCH	// [MANKIND-ADD]- DANGER_STORM
#define ZAP_MINOR_STORM_FLAGS ZAP_OBJ_DAMAGE | ZAP_MOB_DAMAGE		// [MANKIND-ADD]- DANGER_STORM
