...
// [MANKIND-EDIT] - RETURN_CONTENT - CLOWN_RETURN_CONTENT
/*
#define JOB_DISPLAY_ORDER_CURATOR 64
#define JOB_DISPLAY_ORDER_LAWYER 65
#define JOB_DISPLAY_ORDER_CHAPLAIN 66
#define JOB_DISPLAY_ORDER_AI 67
#define JOB_DISPLAY_ORDER_CYBORG 68
*/
