...
// [MANKIND-EDIT] - MANKIND_BALANCE_CD - Меняем размер на нормал
...
// [MANKIND-EDIT]
//#define STORAGE_VOLUME_SATCHEL (DEFAULT_VOLUME_NORMAL * 5) //5 normal items // ORIGINAL
...
#define STORAGE_VOLUME_BAG_OF_HOLDING (DEFAULT_VOLUME_NORMAL * 15) //1.5x normal
