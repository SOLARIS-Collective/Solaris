...
#define TAJARA_MASK_PATH 'modular_mankind/_storage_icons/icons/items/clothing/mask/overlay/onmob_mask_tajara.dmi'
#define TAJARA_HEAD_PATH 'modular_mankind/_storage_icons/icons/items/clothing/head/overlay/onmob_head_tajara.dmi'
#define TAJARA_SUIT_PATH 'modular_mankind/_storage_icons/icons/items/clothing/suit/overlay/onmob_suit_tajara.dmi'
