...
#define SHIP_DEFAULT_MAX_TARGET_RANGE 45
...
/// Событие: цель потеряна
#define COMBAT_EVENT_TARGET_LOST "target_lost"

/// Событие: изменён статус боя
