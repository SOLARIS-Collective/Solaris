...
#define EQUIP_DELAY_OVERSUIT (2 SECONDS)

#define EQUIP_DELAY_SUIT (1 SECONDS)

#define EQUIP_DELAY_BOOTS (0 SECONDS)
#define EQUIP_DELAY_HELMET (0.5 SECONDS)
#define EQUIP_DELAY_SHOES (0 SECONDS)
#define EQUIP_DELAY_COAT (0 SECONDS)
#define EQUIP_DELAY_UNDERSUIT (1 SECONDS)

#define EQUIP_DELAY_MASK (0.5 SECONDS)
#define EQUIP_DELAY_BACK (1 SECONDS)
