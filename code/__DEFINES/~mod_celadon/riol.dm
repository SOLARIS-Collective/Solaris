...
#define RIOL_MASK_PATH 'mod_celadon/_storage_icons/icons/items/clothing/mask/overlay/onmob_mask_riol.dmi'
#define RIOL_HEAD_PATH 'mod_celadon/_storage_icons/icons/items/clothing/head/overlay/onmob_head_riol.dmi'
#define RIOL_SUIT_PATH 'mod_celadon/_storage_icons/icons/items/clothing/suit/overlay/onmob_suit_riol.dmi'
