...
// [MANKIND-EDIT] - MANKIND_CONFIGS_MAPS - добавляем в лист дефайн
// #define DYNAMIC_WORLD_LIST_ALL list(\ // MANKIND-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_LAVA,\ // MANKIND-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_ICE,\ // MANKIND-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_SAND,\ // MANKIND-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_JUNGLE,\ // MANKIND-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_ROCKPLANET,\ // MANKIND-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_BEACHPLANET,\ // MANKIND-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_WASTEPLANET,\ // MANKIND-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_REEBE,\ // MANKIND-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_ASTEROID,\ // MANKIND-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_SPACERUIN,\ // MANKIND-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_GAS_GIANT,\ // MANKIND-EDIT -> ORIGINAL
// 	DYNAMIC_WORLD_PLASMA_GIANT) // MANKIND-EDIT -> ORIGINAL
