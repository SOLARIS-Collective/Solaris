...
// #define RUINTYPE_LIST_ALL list(\ // ORIGINAL
// 	RUINTYPE_SPACE,\ // ORIGINAL
// 	RUINTYPE_LAVA,\ // ORIGINAL
// 	RUINTYPE_ICE,\ // ORIGINAL
// 	RUINTYPE_SAND,\ // ORIGINAL
// 	RUINTYPE_JUNGLE,\ // ORIGINAL
// 	RUINTYPE_ROCK,\ // ORIGINAL
// 	RUINTYPE_BEACH,\ // ORIGINAL
// 	RUINTYPE_WASTE,\ // ORIGINAL
// 	RUINTYPE_YELLOW,\ // ORIGINAL
// 	RUINTYPE_EVERYTHING) // ORIGINAL
