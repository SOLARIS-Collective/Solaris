...
// #define RUINTYPE_LIST_ALL list(\ // MANKIND-EDIT -> ORIGINAL
// 	RUINTYPE_SPACE,\ // MANKIND-EDIT -> ORIGINAL
// 	RUINTYPE_LAVA,\ // MANKIND-EDIT -> ORIGINAL
// 	RUINTYPE_ICE,\ // MANKIND-EDIT -> ORIGINAL
// 	RUINTYPE_SAND,\ // MANKIND-EDIT -> ORIGINAL
// 	RUINTYPE_JUNGLE,\ // MANKIND-EDIT -> ORIGINAL
// 	RUINTYPE_ROCK,\ // MANKIND-EDIT -> ORIGINAL
// 	RUINTYPE_BEACH,\ // MANKIND-EDIT -> ORIGINAL
// 	RUINTYPE_WASTE,\ // MANKIND-EDIT -> ORIGINAL
// 	RUINTYPE_YELLOW,\ // MANKIND-EDIT -> ORIGINAL
// 	RUINTYPE_EVERYTHING) // MANKIND-EDIT -> ORIGINAL
